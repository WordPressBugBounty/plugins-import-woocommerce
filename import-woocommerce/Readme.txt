...
= 2.5 =
* Upgrade now for Single CSV Import for WooCommerce product variations.

= 2.4 =
* Added: import support for WooCommerce orders, including personalized product details from Woo Extra Product Option fields
